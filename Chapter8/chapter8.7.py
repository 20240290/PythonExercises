...
#Module import
from Chap8Module import make_album
from Chap8Module import make_album_with_songs
...
print(f"{make_album('Man in a mission/Milet','Kizuna no Kizeki')}\n")
print(f"{make_album('My First Story/Hyde','Mugen')}\n")
print(f"{make_album('OneRepublic','Nobody')}\n")
...
print(f"{make_album_with_songs('My First Story/Hyde','Mugen', 5)}\n")
print(f"{make_album_with_songs('OneRepublic','Nobody')}\n")
print(f"{make_album_with_songs('Man in a mission/Milet','Kizuna no Kizeki', 10)}\n")